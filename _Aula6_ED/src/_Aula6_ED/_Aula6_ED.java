...
public class _Aula6_ED {
	...
	public static void demiteFuncionarios(LinkedList<Trabalhador> func) {
				/*
		método da classe “_Aula6_ED“ a ser desenvolvido
		encarregado de remover funcionários 
		demitidos da LinkedList func que armazena objetos do tipo  Trabalhador. 
		Enquanto o usuário desejar, você deve solicitar o número do funcionário (id) 
		a ser demitido (removido da lista), se o funcionário existir, deve ser 
		removido da LinkedList e apresentada a mensagem “Funcionário ID encontrado e 
		removido com sucesso!”. Caso não exista na lista, apresenta a mensagem 

...
public class LinkedList<T> {
	...
	/*
		   método interno à classe LinkedList a ser desenvolvido
		   responsável por concatenar a “lista” passada 
		   como parâmetro ao final da lista original desta classe. 
		*/
	}
...
/* ** Métodos para Implementar ***
	...
	// Método para atualizar o salário de um trabalhador pelo ID
	public boolean atualizaSalario(int id, float novoSalario) {
    // Implementar o método
	}

	// Método para filtrar trabalhadores por cargo
